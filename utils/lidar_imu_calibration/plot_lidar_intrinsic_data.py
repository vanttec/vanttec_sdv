...
def load_lidar_intrinsic_data(files):
    filenames = files
...
if __name__ == "__main__":
    ...
    est_list, gt_df =  load_lidar_intrinsic_data(args.files)
    ...
    fig, axs = plt.subplots(nrows=6, ncols=1, sharex=True, sharey=False, figsize=(18, 6))
