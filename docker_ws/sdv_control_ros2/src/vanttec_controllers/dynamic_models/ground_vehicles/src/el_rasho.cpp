...
namespace cafe
{
    ...
    Cafe::Cafe(rclcpp::Node::SharedPtr node,float   sample_time): node_(node), CarDynamicModel(sample_time)
    {
        ...
        sub2_ = node_->create_subscription<sdv_msgs::msg::ThrustControl>("/car_control/car_control_node/force", 10,std::bind(&CarDynamicModel::setForceInput, this, std::placeholders::_1));
        sub3_ = node_->create_subscription<sdv_msgs::msg::VehicleControl>("/sdv/vanttec_vehicle/vehicle_control_cmd_manual", 10,std::bind(&CarDynamicModel::manual_control, this, std::placeholders::_1));
    }
Cafe::~Cafe(){}
} // namespace cafe
