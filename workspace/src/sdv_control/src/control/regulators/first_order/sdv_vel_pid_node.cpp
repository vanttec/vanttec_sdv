...
class SDV_VelPidNode : public rclcpp::Node {
    public:
        SDV_VelPidNode() : Node("sdv_vel_pid_node") {
            ...
            updateTimer =
                this->create_wall_timer(10ms, std::bind(&SDV_VelPidNode::update, this));
        }
...
int main(int argc, char **argv) {
    ...
    rclcpp::spin(std::make_shared<SDV_VelPidNode>());
    rclcpp::shutdown();
    return 0;
}