...
✅ Ensure Y_residual is normalized: Avoids output scale mismatch.
✅ Increase weight_decay=1e-3: Improves generalization.
✅ Lower initial lr=5e-4: Helps with stability.
✅ Check initial GRU outputs: Debugs abnormal predictions.
    Stop loss from 1e-4 to 1e-6
    50 to 100 epochs
"""
...
plt.savefig("/docker-ros/ws/src/tests/GRU/test2/training_loss.png")
# plt.show()
...
with open("/docker-ros/ws/src/tests/GRU/test2/test_results.txt", "w") as f:
...
plt.legend()
plt.grid(True)
plt.savefig("/docker-ros/ws/src/tests/GRU/test2/residual_predictions.png")
# plt.show()

# === 7. Save Model ===
print("Saving model...")
torch.save(model.state_dict(), "/docker-ros/ws/src/tests/GRU/test2/gru_residual_dynamics.pth")
...
model_script_path = "/docker-ros/ws/src/tests/GRU/test2/gru_residual_dynamics.pt"
