...
#include "sdv_msgs/msg/detail/panel_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/byte_multi_array__functions.h"  // xboxcontrol
...
using _PanelMsg__ros_msg_type = sdv_msgs__msg__PanelMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: xboxcontrol
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, std_msgs, msg, ByteMultiArray
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->xboxcontrol, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_std_msgs__msg__ByteMultiArray(
...
static uint32_t _PanelMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_msgs__msg__PanelMsg(
  ...
  size_t current_alignment)
{
  ...
  // member: xboxcontrol
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_std_msgs__msg__ByteMultiArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs__msg__PanelMsg;
    is_plain =
      (
...
static size_t _PanelMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_msgs__msg__PanelMsg(
