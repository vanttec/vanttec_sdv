...
#ifndef SDV_MSGS__MSG__DETAIL__VEHICLE_INFO__STRUCT_HPP_
#define SDV_MSGS__MSG__DETAIL__VEHICLE_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sdv_msgs__msg__VehicleInfo __attribute__((deprecated))
#else
# define DEPRECATED__sdv_msgs__msg__VehicleInfo __declspec(deprecated)
#endif
...
struct VehicleInfo_
{
  ...
  using _wheels_type =
    std::vector<sdv_msgs::msg::VehicleInfoWheel_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<sdv_msgs::msg::VehicleInfoWheel_<ContainerAllocator>>>;
  _wheels_type wheels;
  using _max_rpm_type =
    float;
  ...
  Type & set__wheels(
    const std::vector<sdv_msgs::msg::VehicleInfoWheel_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<sdv_msgs::msg::VehicleInfoWheel_<ContainerAllocator>>> & _arg)
  {
    this->wheels = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    sdv_msgs::msg::VehicleInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const sdv_msgs::msg::VehicleInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sdv_msgs::msg::VehicleInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sdv_msgs__msg__VehicleInfo
    std::shared_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sdv_msgs__msg__VehicleInfo
    std::shared_ptr<sdv_msgs::msg::VehicleInfo_<ContainerAllocator> const>
...
using VehicleInfo =
  sdv_msgs::msg::VehicleInfo_<std::allocator<void>>;
...
#endif  // SDV_MSGS__MSG__DETAIL__VEHICLE_INFO__STRUCT_HPP_
