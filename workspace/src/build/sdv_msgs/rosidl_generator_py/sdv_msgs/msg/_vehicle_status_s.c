...
bool sdv_msgs__msg__vehicle_control__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * sdv_msgs__msg__vehicle_control__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool sdv_msgs__msg__vehicle_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._vehicle_status.VehicleStatus", full_classname_dest, 42) == 0);
  }
  sdv_msgs__msg__VehicleStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // control
    ...
    if (!sdv_msgs__msg__vehicle_control__convert_from_py(field, &ros_message->control)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * sdv_msgs__msg__vehicle_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._vehicle_status");
  ...
  {  // control
    PyObject * field = NULL;
    field = sdv_msgs__msg__vehicle_control__convert_to_py(&ros_message->control);
    if (!field) {
      return NULL;
    }
    {
