...
static const _VehicleInfoWheel_type_support_symbol_names_t _VehicleInfoWheel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_msgs, msg, VehicleInfoWheel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sdv_msgs, msg, VehicleInfoWheel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sdv_msgs, msg, VehicleInfoWheel)() {
  return &::sdv_msgs::msg::rosidl_typesupport_c::VehicleInfoWheel_message_type_support_handle;
}
