...
#include "sdv_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_msgs::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs::msg::State & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs::msg::State;
    is_plain =
      (
      offsetof(DataType, accx) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msgs, msg, State)() {
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
