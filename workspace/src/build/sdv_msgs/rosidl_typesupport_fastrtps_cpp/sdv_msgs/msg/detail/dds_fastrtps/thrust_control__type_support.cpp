...
#include "sdv_msgs/msg/detail/thrust_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_msgs::msg::ThrustControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs::msg::ThrustControl & ros_message)
{
  // Member: tau_x
  cdr >> ros_message.tau_x;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sdv_msgs
max_serialized_size_ThrustControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs::msg::ThrustControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::ThrustControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msgs::msg::ThrustControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ThrustControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::ThrustControl *>(
...
static size_t _ThrustControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ThrustControl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ThrustControl__callbacks = {
  "sdv_msgs::msg",
  "ThrustControl",
...
static rosidl_message_type_support_t _ThrustControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ThrustControl__callbacks,
...
{
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_ThrustControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msgs, msg, ThrustControl)() {
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_ThrustControl__handle;
}
