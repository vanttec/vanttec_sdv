...
bool sdv_msgs__msg__vehicle_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._vehicle_control.VehicleControl", full_classname_dest, 44) == 0);
  }
  sdv_msgs__msg__VehicleControl * ros_message = _ros_message;
  {  // header
...
PyObject * sdv_msgs__msg__vehicle_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._vehicle_control");
