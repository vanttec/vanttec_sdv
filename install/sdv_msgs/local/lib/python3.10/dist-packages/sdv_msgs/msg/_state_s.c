...
bool sdv_msgs__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._state.State", full_classname_dest, 25) == 0);
  }
  sdv_msgs__msg__State * ros_message = _ros_message;
  {  // x
...
PyObject * sdv_msgs__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._state");
