...
bool sdv_msgs__msg__eta_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._eta_pose.EtaPose", full_classname_dest, 30) == 0);
  }
  sdv_msgs__msg__EtaPose * ros_message = _ros_message;
  {  // x
  ...
  {  // phi
    ...
    assert(PyFloat_Check(field));
    ros_message->phi = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // theta
...
{
  /* NOTE(esteve): Call constructor of EtaPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._eta_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EtaPose");
