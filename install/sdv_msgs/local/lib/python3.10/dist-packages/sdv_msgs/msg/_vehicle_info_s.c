...
bool sdv_msgs__msg__vehicle_info_wheel__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool sdv_msgs__msg__vehicle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._vehicle_info.VehicleInfo", full_classname_dest, 38) == 0);
  }
  sdv_msgs__msg__VehicleInfo * ros_message = _ros_message;
  {  // id
  ...
  {  // wheels
    ...
    if (!sdv_msgs__msg__VehicleInfoWheel__Sequence__init(&(ros_message->wheels), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create sdv_msgs__msg__VehicleInfoWheel__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    sdv_msgs__msg__VehicleInfoWheel * dest = ros_message->wheels.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!sdv_msgs__msg__vehicle_info_wheel__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * sdv_msgs__msg__vehicle_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._vehicle_info");
  ...
  {  // wheels
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = sdv_msgs__msg__vehicle_info_wheel__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
