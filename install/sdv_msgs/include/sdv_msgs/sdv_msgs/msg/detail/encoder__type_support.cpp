...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Encoder_message_member_array[3] = {
  {
    ...
    offsetof(sdv_msgs::msg::Encoder, abs_angle),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_msgs::msg::Encoder, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_msgs::msg::Encoder, turn),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
