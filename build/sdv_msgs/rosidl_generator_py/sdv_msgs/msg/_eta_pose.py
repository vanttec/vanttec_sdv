...
class Metaclass_EtaPose(type):
    """Metaclass of message 'EtaPose'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sdv_msgs.msg.EtaPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__eta_pose
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__eta_pose
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__eta_pose
            cls._TYPE_SUPPORT = module.type_support_msg__msg__eta_pose
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__eta_pose
...
class EtaPose(metaclass=Metaclass_EtaPose):
    """Message class 'EtaPose'."""
    ...
    def phi(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'phi' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._phi = value
