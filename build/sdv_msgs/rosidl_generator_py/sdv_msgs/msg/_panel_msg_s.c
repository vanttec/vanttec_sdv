...
bool sdv_msgs__msg__panel_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._panel_msg.PanelMsg", full_classname_dest, 32) == 0);
  }
  sdv_msgs__msg__PanelMsg * ros_message = _ros_message;
  {  // wiper
  ...
  {  // xboxcontrol
    PyObject * field = PyObject_GetAttrString(_pymsg, "xboxcontrol");
    if (!field) {
      return false;
    }
    if (!std_msgs__msg__byte_multi_array__convert_from_py(field, &ros_message->xboxcontrol)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * sdv_msgs__msg__panel_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._panel_msg");
  ...
  {  // xboxcontrol
    PyObject * field = NULL;
    field = std_msgs__msg__byte_multi_array__convert_to_py(&ros_message->xboxcontrol);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "xboxcontrol", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
