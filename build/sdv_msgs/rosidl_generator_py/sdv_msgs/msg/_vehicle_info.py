...
class Metaclass_VehicleInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from sdv_msgs.msg import VehicleInfoWheel
            if VehicleInfoWheel.__class__._TYPE_SUPPORT is None:
                VehicleInfoWheel.__class__.__import_type_support__()
...
class VehicleInfo(metaclass=Metaclass_VehicleInfo):
    ...
    _fields_and_field_types = {
        ...
        'type': 'string',
        'rolename': 'string',
        'wheels': 'sequence<sdv_msgs/VehicleInfoWheel>',
        'max_rpm': 'float',
        'moi': 'float',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['sdv_msgs', 'msg'], 'VehicleInfoWheel')),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, VehicleInfoWheel) for v in value) and
                 True), \
                "The 'wheels' field must be a set or sequence and each value of type 'VehicleInfoWheel'"
        self._wheels = value
