...
#include "sdv_msgs/msg/detail/vehicle_status__rosidl_typesupport_fastrtps_c.h"
...
#include "sdv_msgs/msg/detail/vehicle_control__functions.h"  // control
...
using _VehicleStatus__ros_msg_type = sdv_msgs__msg__VehicleStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: control
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, sdv_msgs, msg, VehicleControl
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_sdv_msgs__msg__VehicleControl(
...
static uint32_t _VehicleStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_msgs__msg__VehicleStatus(
  ...
  size_t current_alignment)
{
  ...
  // member: control
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_sdv_msgs__msg__VehicleControl(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs__msg__VehicleStatus;
    is_plain =
      (
...
static size_t _VehicleStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_msgs__msg__VehicleStatus(
