...
#include "sdv_msgs/msg/detail/vehicle_info__rosidl_typesupport_fastrtps_c.h"
...
#include "sdv_msgs/msg/detail/vehicle_info_wheel__functions.h"  // wheels
...
using _VehicleInfo__ros_msg_type = sdv_msgs__msg__VehicleInfo;
  ...
  // Field name: wheels
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, sdv_msgs, msg, VehicleInfoWheel
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: wheels
  {
    ...
    if (ros_message->wheels.data) {
      sdv_msgs__msg__VehicleInfoWheel__Sequence__fini(&ros_message->wheels);
    }
    if (!sdv_msgs__msg__VehicleInfoWheel__Sequence__init(&ros_message->wheels, size)) {
...
size_t get_serialized_size_sdv_msgs__msg__VehicleInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleInfo__ros_msg_type * ros_message = static_cast<const _VehicleInfo__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name wheels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_sdv_msgs__msg__VehicleInfoWheel(
...
static uint32_t _VehicleInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_msgs__msg__VehicleInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t max_serialized_size_sdv_msgs__msg__VehicleInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: wheels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_sdv_msgs__msg__VehicleInfoWheel(
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs__msg__VehicleInfo;
    is_plain =
      (
...
static size_t _VehicleInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_msgs__msg__VehicleInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_msgs, msg, VehicleInfo)() {
