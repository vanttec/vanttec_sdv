...
class VehicleStatus(metaclass=Metaclass_VehicleStatus):
    ...
    _fields_and_field_types = {
        ...
        'control': 'sdv_msgs/VehicleControl',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['sdv_msgs', 'msg'], 'VehicleControl'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from sdv_msgs.msg import VehicleControl
        self.control = kwargs.get('control', VehicleControl())
    ...
    def control(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'control' field must be a sub message of type 'VehicleControl'"
        self._control = value
