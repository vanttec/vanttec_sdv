...
bool sdv_msgs__msg__encoder__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._encoder.Encoder", full_classname_dest, 29) == 0);
  }
  sdv_msgs__msg__Encoder * ros_message = _ros_message;
  {  // abs_angle
  ...
  {  // turn
    ...
    ros_message->turn = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * sdv_msgs__msg__encoder__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._encoder");
  ...
  {  // turn
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->turn);
    {
