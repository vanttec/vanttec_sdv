...
bool sdv_msgs__msg__vehicle_info_wheel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._vehicle_info_wheel.VehicleInfoWheel", full_classname_dest, 49) == 0);
  }
  sdv_msgs__msg__VehicleInfoWheel * ros_message = _ros_message;
  {  // tire_friction
...
{
  /* NOTE(esteve): Call constructor of VehicleInfoWheel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._vehicle_info_wheel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleInfoWheel");
