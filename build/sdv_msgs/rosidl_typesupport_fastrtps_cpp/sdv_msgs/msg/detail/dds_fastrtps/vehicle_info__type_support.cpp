...
#include "sdv_msgs/msg/detail/vehicle_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const sdv_msgs::msg::VehicleInfoWheel &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  sdv_msgs::msg::VehicleInfoWheel &);
...
cdr_serialize(
  const sdv_msgs::msg::VehicleInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs::msg::VehicleInfo & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  // Member: wheels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sdv_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleInfoWheel(
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs::msg::VehicleInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::VehicleInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msgs::msg::VehicleInfo *>(
    untyped_ros_message);
...
{
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_VehicleInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msgs, msg, VehicleInfo)() {
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_VehicleInfo__handle;
}
